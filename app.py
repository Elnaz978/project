...
def main():
    ...
    st.title("Elnaz Rahimi")
    st.markdown(
         f"""
         <style>
         .stApp {{
             background-image: url("https://www.pexels.com/photo/sandy-beach-by-vast-sea-2386141/?cs=srgb&dl=pexels-adrien-olichon-2387793.jpg&fm=jpg");
